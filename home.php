	  ...
	  <div class="content-wrapper">
	    <div class="container">
	      ...
	      <section class="content">
	      	...
	      	?>
	      	<h1 class="page-header text-center title"><b><?php echo strtoupper(e($title)); ?></b></h1>
	        <div class="row">
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	elseif(!election_is_open($conn)){
				    		?>
				    		<div class="callout callout-info text-center">
				    			<h3>Voting is currently closed.</h3>
				    			<p>Please wait for the election administrator to open the ballot.</p>
				    		</div>
				    		<?php
				    	}
				    	else{
				        		...
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										echo '
											<div class="row">
												<div class="col-xs-12">
													<div class="box box-solid" id="'.e($row['id']).'">
														<div class="box-header with-border">
															<h3 class="box-title"><b>'.e($row['description']).'</b></h3>
														</div>
														<div class="box-body">
															<p>'.$instruct.'
																<span class="pull-right">
																	<button type="button" class="btn btn-success btn-sm btn-flat reset" data-desc="'.e(slugify($row['description'])).'"><i class="fa fa-refresh"></i> Reset</button>
																</span>
															</p>
